...
export default function PurchaseOrdersPage() {
    ...
    const columns = [
        ...
        },
        {
            ...
            header: "Status",
            render: (value: any) => (
                <span className={`px-2 py-1 rounded text-xs font-semibold uppercase ${value === 'received' ? 'bg-green-50 text-green-700 border border-green-200' :
                    value === 'cancelled' ? 'bg-red-100 text-red-800' :
                        value === 'approved' ? 'bg-primary/10 text-primary border border-primary/40' :
        ...
        <div className="space-y-6 min-w-0">
            <div className="flex justify-between items-center">
                ...
                <Link
                    ...
                    className="bg-primary hover:bg-primary-dark text-white font-bold px-4 py-2 rounded-lg transition-colors"
                >
