...
interface DebtWithPayments extends ApiDebt {
...
export default function DebtsPage() {
    ...
    const fetchDebts = async () => {
        ...
        try {
            ...
            // Actually, in database we usually store a CurrentBalance on the doc or fetch all payments.
    ...
    const columns = [
        {
            ...
            render: (value: string, row: ApiDebt) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4">
                        <div className="p-3 bg-gray-100 rounded-lg">
                            <ArrowDownCircleIcon className="h-6 w-6 text-gray-700" />
                        </div>
                        <div>
