            ...
            <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-300">
                ...
                <div className="p-8 space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all"
                    ...
                    <div className="flex gap-3 pt-4">
                        <button
                            onClick={handleClose}
                            className="flex-1 py-3 rounded-xl text-gray-700 bg-gray-100 hover:bg-gray-200 transition-all font-bold text-sm uppercase tracking-widest"
                            disabled={isLoading}
                        >
                            Cancel
                        </button>
